...
struct textures_s{
    ...
    SDL_Texture* personnage; /*!< Texture liée à l'image du personnage.*/
};
/**
...
//Ceci est la ligne 70
//Ceci est la ligne 69
...
void init_data(world_t * world){
    world->joueur_x = (SCREEN_WIDTH/2)-(SPRITE_SIZE/2);
    world->joueur_y = (SCREEN_HEIGHT/2)-(SPRITE_SIZE/2);
        ...
        if( event->type == SDL_QUIT ) {
         ...
         if(event->type == SDL_KEYDOWN){
             ...
             if(event->key.keysym.sym == SDLK_z){
                 ...
                 world->joueur_y -= MOVING_STEP ;   //On avance de la longueur MOVING_STEP
              }
...
void refresh_graphics(SDL_Renderer *renderer, world_t *world,textures_t *textures){
    ...
    apply_background(renderer, textures);
     apply_texture(textures->personnage, renderer, world->joueur_x, world->joueur_y);
